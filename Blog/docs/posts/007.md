...
``` bash
git add .
git commit -m "[Perla] Modification du README"
git push
``` 
...
```
pick d34db33 Commit [Perla] modifiant README
pick a1b2c3f Commit [Perla] modifiant README
pick f5e6d7a Commit [Perla] ajout d'une fonction
```
